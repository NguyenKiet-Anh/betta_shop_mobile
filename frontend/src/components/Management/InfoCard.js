...
export const InfoCard = ({ item, onDeletePress, navigation }) => {
  return (
    ...
    >
      ...
      <View style={styles.info}>
        <View style={styles.infoSection}>
          <Text style={styles.infoTextStyle} numberOfLines={1}>
            {item.TenKhachHang ? item.TenKhachHang : item.TenMatHang}
          </Text>
          {item.SoDienThoai ? (
            ...
            <View>
              {!item.KhuyenMai && (
                <View style={styles.priceInfo}>
                  <Fontisto
                    ...
                    color={"#b141aa"}
                  ></Fontisto>
                  <Text style={[styles.infoTextStyle, styles.newPrice]}>
              ...
              {item.KhuyenMai && (
                <View style={styles.priceInfo}>
                  ...
                  ></Fontisto>
                  <Text style={[styles.infoTextStyle, styles.oldPrice]}>
                    {parseInt(item.DonGia)}
                  </Text>
                </View>
              )}
        ...
        {item.MaKhachHang ? (
          ...
          <View style={styles.GenderAndComment}>
            {item.GioiTinh === "M" && (
              <Fontisto name="mars" size={20}></Fontisto>
            )}
            {item.GioiTinh === "F" && (
              <Fontisto name="venus" size={20}></Fontisto>
            )}
      ...
      <TouchableOpacity style={styles.removeButton} onPress={onDeletePress}>
