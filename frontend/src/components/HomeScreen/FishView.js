    ...
    <TouchableOpacity
      ...
      onPress={() => {
        hanldleNavigationForCategories(
          item.MaMatHang,
          item.ma_loai_ca_info.TenLoaiMatHang
        );
      }}
    >
        ...
        <View style={styles.fishInCategoryFlatlistContent}>
          ...
          <View style={styles.fishInCategoryFlatlistBuyFeature}>
            ...
            {item.KhuyenMai && (
              <Text
                style={[
                  styles.fishInCategoryFlatlistPrice,
                  styles.fishInCategoryFlatlistNewPrice,
                ]}
              >
            ...
            <View style={styles.buttonSection}>
              <TouchableOpacity
                onPress={() => {
                  handleAddWishList(item.MaMatHang);
                }}
              >
