                            ...
                            fish.MaMatHang && fish.KhuyenMai && (
                                <View style={styles.container}>       
                                    ...
                                    <View style={styles.content}>
                                        <Text style={styles.fishType}>{fish.ma_loai_ca_info.TenLoaiMatHang}</Text>
                                        ...
                                        <View style={styles.priceInfo}>
                                            <View style={styles.newPriceSection}>
                                                ...
                                                <Text style={styles.fishNewPrice}>{parseInt(fish.GiaKhuyenMai)}</Text>
                                            </View>                                
                                ...
                                <View style={styles.container}>       
                                    ...
                                    <View style={styles.content}>
                                        ...
                                        <View style={styles.priceInfo}>
                                            <View style={styles.newPriceSection}>
                                                <Fontisto name="dollar" size={25} color={"#b141aa"}></Fontisto>
                                                <Text style={styles.fishNewPrice}>{parseInt(fish.Dongia)}</Text>
                                            </View>
                                        </View>
                                        <View style={styles.buttonSection}>
                                            <TouchableOpacity
